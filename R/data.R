...
#' Vermont Center for Geographic Information, and converts it to a SpatRaster
#' object
#'
#' @param aoi sf polygon object with area of interest geometry. CRS must be
#'   defined
...
#'
#' Retrieves 2016 Vermont landcover data for area of interest from the Vermont
#' Center for Geographic Information, and converts it to a SpatRaster object
#'
#' @param aoi sf polygon object with area of interest geometry. CRS must be
#'   defined
#'
